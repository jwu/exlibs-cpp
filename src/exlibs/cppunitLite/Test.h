...
// File         : Test.h
// Author       : Wu Jie 
// Last Change  : 08/18/2009 | 00:28:44 AM | Tuesday,August
// Description  : This is a modified version of CppUnitLite
// ======================================================================================

// #################################################################################
#ifndef TEST_H_1250526531
#define TEST_H_1250526531
// #################################################################################
...
#define TEST(name,classUnderTest,on_off)\
	class classUnderTest##name##Test : public Test\
	{ \
		public: \
			classUnderTest##name##Test () : Test (#name "_" #on_off) {} \
