...
// File         : MultiSet.h
// Author       : Wu Jie 
// Last Change  : 08/17/2009 | 23:32:31 PM | Monday,August
// Description  : 
// ======================================================================================

// #################################################################################
#ifndef MULTISET_H_1250523154
#define MULTISET_H_1250523154
// #################################################################################
...
// class MultiSet
// 
// Purpose: improve version of std::multiset
// 
///////////////////////////////////////////////////////////////////////////////
 
template < typename KEY, typename COMP_FUNC = Less<KEY>, template <class> class TAllocator_T = Managed<EX_ALLOCATOR>::TAllocator >
class MultiSet : protected std::multiset< KEY, COMP_FUNC, ContainerAllocator< KEY, TAllocator_T > >
{
...
public:
    //
    typedef MultiSet< KEY, COMP_FUNC, TAllocator_T > self_t;
    ...
    ///////////////////////////////////////////////////////////////////////////////
    // consturctor & destructors 
    ///////////////////////////////////////////////////////////////////////////////

public:
    //
    MultiSet( const value_t* _pFirst, const value_t* _pLast ) 
        : base_t( _pFirst, _pLast ) 
    {
    }

    //
    MultiSet( c_iterator _first, c_iterator _last )
        : base_t( _first, _last ) 
    {
    }

    //
    MultiSet( const self_t& _set ) 
        : base_t( _set ) 
    {
    }
...
public:
    ...
    //
    INLINE Pair<iterator,bool> insert( const value_t& _val ) { return base_t::insert(_val); }
...
// #################################################################################
#endif // END MULTISET_H_1250523154
// #################################################################################
